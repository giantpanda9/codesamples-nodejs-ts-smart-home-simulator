...
7) changes to settings could be done using a config file available by src/config/config.json , if needed. You also could change there a setting that tells heater that somebody would some return home or not (cominghome: bool)
