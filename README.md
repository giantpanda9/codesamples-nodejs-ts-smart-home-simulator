...
8) if you encounter any issues with building or running for your system, I can build the module for you in a similar system or show on screenshare how this should be done or work
